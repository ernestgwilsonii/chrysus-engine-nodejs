//@ts-check
// REF: https://slack.dev/node-slack-sdk/
const { IncomingWebhook } = require("@slack/webhook"); // https://slack.dev/node-slack-sdk/webhook
...
async function output(output) {
  try {
    if (output) {
      ...
      // Need to consider what is displayed and formatting https://api.slack.com/messaging/webhooks
