  ...
  try {
    ...
    const sqsApp = Consumer.create({
      ...
      handleMessage: async message => {
        ...
        console.log(
          "Chrysus sqsSubscriber - handleMessage: SQS queue message is being handled: " + messageId
        );
        ...
        if (chrysusMessage) {
          ...
          if (res.chrysusStatus === "RECEIVED") {
            ...
            console.log("ChrysusEngine sqsSubscriber Chrysus Message - res.chrysusMessageId: " + res.chrysusMessageId);
    ...
    sqsApp.on("message_received", async message => {
      ...
      console.log(
        "Chrysus sqsSubscriber - message_received: SQS queue message has been received: " + messageId
      );
    });
